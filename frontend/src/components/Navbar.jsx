...
const Navbar = () => {
  ...
  <Link to="/" onClick={() => setMenuOpen(false)} className="block hover:text-pink-500 px-4 py-2 transition">Home</Link>
          ...
          {user ? (
            <>
              <Link to="/profile" onClick={() => setMenuOpen(false)} className="block hover:text-pink-500 px-4 py-2 transition">Profile</Link>
            ...
            <>
              <Link to="/login" onClick={() => setMenuOpen(false)} className="block hover:text-pink-500 px-4 py-2 transition">Login</Link>
              {isHome && (
  <Link
    to="/register"
