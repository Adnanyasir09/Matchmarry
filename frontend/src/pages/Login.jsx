...
const Login = () => {
  ...
  try {
    ...
    if (res.data.user && res.data.token) {
      ...
      const isBasicComplete = profile.age && profile.gender && profile.profession && profile.salary;
      const isAdditionalComplete = profile.maritalStatus && profile.state && profile.diet && profile.bodyType;
      const isPartnerPrefsComplete = profile.partnerPreferences &&
